...
int CServerSocketHelper::Receive(std::string& sReceived)
{
	try
	{
		int iResult = 0;
...
int CServerSocketHelper::Send(const std::string& sMsg, const int icNumOfBytes)
{
	try
	{
...
int CClientSocketHelper::Send(const std::string& sMsg)
{
	try
	{
